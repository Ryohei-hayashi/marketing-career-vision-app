...
import type { SkillAxisId, DiagnosisInput, QuestionsData } from '@/lib/types';

interface DiagnosisClientProps {
  questionsData: QuestionsData;
}

export default function DiagnosisClient({ questionsData }: DiagnosisClientProps) {
  ...
  const stepNames = questionsData.steps.map((s) => s.title);
